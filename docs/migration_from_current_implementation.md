...
- Full production-complete Win32 dialogs/event wiring from Python parity are implemented and documented, with the core parser/config/sequence logic implemented and tested.
